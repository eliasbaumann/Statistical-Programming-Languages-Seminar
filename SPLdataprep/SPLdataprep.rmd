...
getJsonData = function(x){
  ...
  paste(connection,series_id,api_key,file_type,observation_end,observation_start, sep = "")
}

getJsonData("INDPRO")

json = fromJSON("https://api.stlouisfed.org/fred/series/observations?series_id=INDPRO&api_key=4c5743e8fb183ff3f7f47ba1ae651683&file_type=json&observation_end=2017-10-01&observation_start=1950-01-01")
